...
const verifiedCenters = JSON.parse(fs.readFileSync(evacCentersPath, "utf8"));
...
console.log(`Verified LGU/seed centers: ${verifiedCenters.length} records across ${verifiedBarangays} barangays`);
...
console.log(
  "Replace mock entries by adding verified records to data/seed/evac-centers.json."
);
